...
function checkWeather(){
    ...
    const message = weather.toLowerCase() ==='rain'?`Grab your unbrella.`:`Wear your sunglasses.`;
...
function checkVotingAge(){
    ...
    const message = age>=18 ? `You are able to vote.` : `You are not old enough to vote.`;
